...
import SuggestedReading from '../shared/_suggested_reading.mdx'
import SuggestedVideo from '../shared/_suggested_video.mdx'
...
- [How Redpanda's cloud-first storage model reduces TCO](https://redpanda.com/blog/cloud-native-streaming-data-lower-cost)
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/3_Tmdvrp5sU?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>


- YouTube - Intro to Redpanda: Thread-per-core architecture in C++ (60 mins)

<iframe width="560" height="315" src="https://www.youtube.com/embed/guoaxRJG8p8?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>


- YouTube - Differences between Apache Kafka and Redpanda: Thread per Core Architecture (4:30 mins)

<iframe width="560" height="315" src="https://www.youtube.com/embed/UxM1mn1gwoc?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>


- YouTube - Common pitfalls for Redpanda beginners (44:35 mins)

<iframe width="560" height="315" src="https://www.youtube.com/embed/CEVxZznqTDo?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>