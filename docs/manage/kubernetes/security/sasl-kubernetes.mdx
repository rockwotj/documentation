...
- [Securing Redpanda in K8s(Day 2 Ops)](https://killercoda.com/redpanda/scenario/redpanda-k8s-secure)
- [Access-control lists (ACLs) provide a way to configure fine-grained access to provisioned users](../../../security/authorization/#ACLs).
- [Redpanda Helm Specification](../../../../reference/redpanda-helm-spec#authsasl)
- [Redpanda CRD Reference](../../../../reference/crd)
- [`rpk acl`](../../../../reference/rpk/rpk-acl)
