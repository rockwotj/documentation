...
- Avro
- Protobuf
    - Includes support for Protobuf known types ([Protobuf](https://github.com/protocolbuffers/protobuf/tree/main/src/google/protobuf), [Google Common Types](https://github.com/googleapis/googleapis/tree/master/google/type), [Confluent types](https://github.com/emaxerrno/confluent-kafka-go/tree/master/schemaregistry/confluent))
