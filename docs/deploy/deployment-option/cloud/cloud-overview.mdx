...
- [Bring Your Own Cloud (BYOC): best of both worlds](https://redpanda.com/blog/deploy-redpanda-clusters-cloud-aws-gcp)

<SuggestedVideo/>

- YouTube - What is Redpanda BYOC? (3 mins)
  
<iframe width="560" height="315" src="https://www.youtube.com/embed/gVlzsJAYT64?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
