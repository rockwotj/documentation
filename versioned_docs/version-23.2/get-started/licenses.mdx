...
You can deploy Redpanda in a self-hosted environment (Redpanda platform) or as a fully-managed cloud service (Redpanda Cloud). For more information about Redpanda Cloud deployments, see [Dedicated Cloud vs BYOC](../../deploy/deployment-option/cloud/dedicated-byoc/).
