...
- Object storage is deleted asynchronously. When DeleteRecords returns, the partition's start offset will have advanced, but garbage collection of deleted segments may not be complete.
